...
public class Reservation {
    ...
    public void onPostPersist(){
        ...
        // 해당 영화가 Available한 상태인지 체크
        boolean result = true; //ReservationApplication.applicationContext.getBean(cinema.external.MovieService.class).chkAndReqReserve(this.getMovieId());
        ...
        if(result) { 
            ...
            //////////////////////////////
            cinema.external.Payment payment = new cinema.external.Payment();
            payment.setRsvId(this.getRsvId());
            payment.setMovieId(this.getMovieId());
            payment.setStatus("paid");
            ReservationApplication.applicationContext.getBean(cinema.external.PaymentService.class)
